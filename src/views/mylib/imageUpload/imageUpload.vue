<template>
	<Modal v-model="modalShow" width="700" class="upload-modal" @on-visible-change="change">
		<p slot="header" style="text-align:center">
			<span>选择图片</span>
		</p>
		<div>
			<images-default @checkupdate="checkupdate" :propPageSize=8 v-if="modalShow"></images-default>
		</div>
		<Row slot="footer">
...
<style lang="less">
	.upload-modal .ivu-modal-wrap{z-index: 2000!important;}
</style>